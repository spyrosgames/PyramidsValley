...
{
	/*
	transform.rotation = Quaternion.Slerp(transform.rotation, Quaternion.LookRotation(player.position - transform.position), turningSpeed * Time.deltaTime);
	//Debug.Log("Enemy and Player Positions " + Vector3.Distance(player.position, transform.position));
